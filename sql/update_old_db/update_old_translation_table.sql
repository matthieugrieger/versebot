...
ALTER TABLE translation_stats ALTER COLUMN last_used DROP NOT NULL;
ALTER TABLE translation_stats ALTER COLUMN last_used SET DEFAULT NULL;

ALTER TABLE translation_stats ADD COLUMN name TEXT;
ALTER TABLE translation_stats ADD COLUMN lang TEXT;
...
UPDATE translation_stats SET name = 'Russian New Testament: Easy-to-Read Version' WHERE trans = 'ERV-RU';
...
UPDATE translation_stats SET lang = 'amu' WHERE id = 1;
UPDATE translation_stats SET lang = 'ar' WHERE id >= 2 AND id <= 3;
UPDATE translation_stats SET lang = 'awa' WHERE id = 4;
UPDATE translation_stats SET lang = 'bg' WHERE id >= 5 AND id <= 8;
UPDATE translation_stats SET lang = 'cco' WHERE id = 9;
UPDATE translation_stats SET lang = 'ceb' WHERE id = 10;
UPDATE translation_stats SET lang = 'chr' WHERE id = 11;
UPDATE translation_stats SET lang = 'ckw' WHERE id = 12;
UPDATE translation_stats SET lang = 'cs' WHERE id >= 13 AND id <= 14;
UPDATE translation_stats SET lang = 'da' WHERE id >= 15 AND id <= 16;
UPDATE translation_stats SET lang = 'de' WHERE id >= 17 AND id <= 21;
UPDATE translation_stats SET lang = 'en' WHERE id >= 22 AND id <= 67;
UPDATE translation_stats SET lang = 'es' WHERE id >= 68 AND id <= 83;
UPDATE translation_stats SET lang = 'fi' WHERE id = 84;
UPDATE translation_stats SET lang = 'fr' WHERE id >= 85 AND id <= 88;
UPDATE translation_stats SET lang = 'grc' WHERE id >= 89 AND id <= 92;
UPDATE translation_stats SET lang = 'he' WHERE id >= 93 AND id <= 94;
UPDATE translation_stats SET lang = 'hi' WHERE id = 95;
UPDATE translation_stats SET lang = 'hil' WHERE id = 96;
UPDATE translation_stats SET lang = 'hr' WHERE id = 97;
UPDATE translation_stats SET lang = 'ht' WHERE id = 98;
UPDATE translation_stats SET lang = 'hu' WHERE id >= 99 AND id <= 101;
UPDATE translation_stats SET lang = 'hwc' WHERE id = 102;
UPDATE translation_stats SET lang = 'is' WHERE id = 103;
UPDATE translation_stats SET lang = 'it' WHERE id >= 104 AND id <= 108;
UPDATE translation_stats SET lang = 'jac' WHERE id = 109;
UPDATE translation_stats SET lang = 'kek' WHERE id = 110;
UPDATE translation_stats SET lang = 'la' WHERE id = 111;
UPDATE translation_stats SET lang = 'mi' WHERE id = 112;
UPDATE translation_stats SET lang = 'mk' WHERE id = 113;
UPDATE translation_stats SET lang = 'mr' WHERE id = 114;
UPDATE translation_stats SET lang = 'mvc' WHERE id = 115;
UPDATE translation_stats SET lang = 'mvj' WHERE id = 116;
UPDATE translation_stats SET lang = 'nds' WHERE id = 117;
UPDATE translation_stats SET lang = 'ne' WHERE id = 118;
UPDATE translation_stats SET lang = 'ngu' WHERE id = 119;
UPDATE translation_stats SET lang = 'nl' WHERE id = 120;
UPDATE translation_stats SET lang = 'no' WHERE id >= 121 AND id <= 122;
UPDATE translation_stats SET lang = 'or' WHERE id = 123;
UPDATE translation_stats SET lang = 'pa' WHERE id = 124;
UPDATE translation_stats SET lang = 'pl' WHERE id >= 125 AND id <= 126;
UPDATE translation_stats SET lang = 'ppl' WHERE id = 127;
UPDATE translation_stats SET lang = 'pt' WHERE id >= 128 AND id <= 131;
UPDATE translation_stats SET lang = 'qu' WHERE id = 132;
UPDATE translation_stats SET lang = 'qut' WHERE id = 133;
UPDATE translation_stats SET lang = 'ro' WHERE id >= 134 AND id <= 135;
UPDATE translation_stats SET lang = 'ru' WHERE id >= 136 AND id <= 138;
UPDATE translation_stats SET lang = 'sk' WHERE id = 139;
UPDATE translation_stats SET lang = 'so' WHERE id = 140;
UPDATE translation_stats SET lang = 'sq' WHERE id = 141;
UPDATE translation_stats SET lang = 'sr' WHERE id = 142;
UPDATE translation_stats SET lang = 'sv' WHERE id >= 143 AND id <= 145;
UPDATE translation_stats SET lang = 'sw' WHERE id = 146;
UPDATE translation_stats SET lang = 'ta' WHERE id = 147;
UPDATE translation_stats SET lang = 'th' WHERE id >= 148 AND id <= 149;
UPDATE translation_stats SET lang = 'tl' WHERE id = 150;
UPDATE translation_stats SET lang = 'twi' WHERE id = 151;
UPDATE translation_stats SET lang = 'uk' WHERE id >= 152 AND id <= 153;
UPDATE translation_stats SET lang = 'ur' WHERE id = 154;
UPDATE translation_stats SET lang = 'usp' WHERE id = 155;
UPDATE translation_stats SET lang = 'vi' WHERE id >= 156 AND id <= 158;
UPDATE translation_stats SET lang = 'zh' WHERE id >= 159 AND id <= 167;
UPDATE translation_stats SET lang = 'en' WHERE id >= 168 AND id <= 169;
